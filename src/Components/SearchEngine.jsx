// src/Components/Search.jsx  (or SearchEngine.jsx if that's the file name)
          ...
          {!loading && filteredOffers.length === 0 && !error && (
            ...
            >
              <p className="text-sm text-[#666]">
                Aucune offre trouvée. Essayez d&apos;élargir votre recherche ou
                de réinitialiser certains filtres.
              </p>
            </motion.div>
          )}
